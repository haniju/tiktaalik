              ...
              >
                ...
                <div style={{
                  ...
                  <button
                    ...
                    onClick={e => { e.stopPropagation(); onDeleteItem(id); setPanelSelected(p => p.filter(x => x !== id)); }}
                  >
                  ...
                  <button
                    style={s.badgeBtn}
                    onPointerDown={e => e.stopPropagation()}
                    onClick={e => { e.stopPropagation(); onDeselect(id); setPanelSelected(p => p.filter(x => x !== id)); }}
                  >
