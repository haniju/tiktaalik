# Tiktaalik — État du projet (2026-03-25)
...
| Fichier | Rôle |
|---|---|
| `src/components/SketchScreen.tsx` | Composant principal (~1160 lignes). Canvas, tous les handlers d'événements, état des layers. |
...
| `src/components/ActionFABs.tsx` | FABs flottants (save, mode select/move/draw). |
...
- Scroll horizontal : `setPointerCapture` déplacé dans le timer long-press (ne bloque plus le scroll natif).
...
| Export SVG | ✅ Chrono correct (textes dans la pile) |
...
| SelectionPanel | ✅ Vignettes, scroll horizontal |
...
| Renommage | ✅ |
| Suppression | ✅ |
| Vignettes | ✅ Thumbnail généré au save |
